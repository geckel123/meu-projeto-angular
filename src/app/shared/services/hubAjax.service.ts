...
declare var manipulandocookies: any;
declare var data: any;


@Injectable({providedIn: 'root'})
export class HubAjaxService {
...
this.hubAjax = $.hubAjax;
console.log("aqui");
console.log(this.hubAjax);
    }
}
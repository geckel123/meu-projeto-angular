...
function calculoTrivial(valor, base, validarTamanho){
    if(!validarTamanho && tamanhoNaoE(valor,undefined)) {
        return false;
    }

    if(eIndefinido(base)) {
        base = primeiros(valor,undefined);
    }

    var digito = substracaoPor11SeMaiorQue2CasoContrario0(mod(base,undefined,undefined));
...
var funcoes = {
    ba: function(valor){
        if(tamanhoNaoE(valor, 8) && tamanhoNaoE(valor, undefined)) {
            return false;
        }
        ...
        if('0123458'.split('').indexOf(digitoComparacao) !== -1) {
            ...
            segundoResto = mod(base, segundoMultiplicador,undefined);
            segundoDigito = substracaoPor11SeMaiorQue2CasoContrario0(segundoResto);

            primeiroResto = mod(base + segundoDigito, primeiroMultiplicador, undefined);
    ...
    se: function(valor){
        if(tamanhoNaoE(valor,undefined)) {
            return false;
        }

        return calculoTrivial(valor,undefined,undefined);
    },
    ...
    al: function(valor){
        ...
        var base = primeiros(valor,undefined);

        var resto = mod(base,undefined,undefined) * 10;
        var divResto = resto/11;
        var divRestoChar = divResto.toString();
        resto = resto - (parseInt(divRestoChar, 10) * 11);
    ...
    rn: function(valor){
        if(tamanhoNaoE(valor,undefined) && tamanhoNaoE(valor, 10)) {
            return false;
        }
        ...
        var resto = (mod(base, multiplicadores,undefined) * 10) % 11;
        var digito = resto === 10 ? 0 : resto;
    ...
    ap: function(valor){
        ...
        var resto = mod(p + base, [2, 3, 4, 5, 6, 7, 8, 9, 1],undefined);
    ...
    ro: function(valor){
        ...
        if(tamanhoE(valor, 9)) {
            ...
            digito = substracaoPor11SeMaiorQue2CasoContrario0(mod(base,undefined,undefined));

            return valor === valor.substring(0, 3) + base + digito;
        } else if(tamanhoE(valor, 14)) {
            base = primeiros(valor, 13);
            resultadoMod = mod(base,undefined,undefined);
    ...
    rj: function(valor){
        ...
        var digito = substracaoPor11SeMaiorQue2CasoContrario0(mod(base, serie(2, 7),undefined));
    ...
    pr: function(valor){
        ...
        var restoPrimeiro = mod(base, serie(2, 7),undefined);
        var primeiro = 11 - restoPrimeiro >= 10 ? 0 : 11 - restoPrimeiro;

        var restoSegundo = mod(base + primeiro, serie(2, 7),undefined);
    ...
    pe: function(valor){
        ...
        var restoPrimeiro = mod(base,undefined,undefined);
        var primeiro = 11 - restoPrimeiro >= 10 ? 0 : 11 - restoPrimeiro;

        var restoSegundo = mod(base + primeiro,undefined,undefined);
        var segundo = 11 - restoSegundo >= 10 ? 0 : 11 - restoSegundo;
    ...
    ac: function(valor){
        ...
        var primeiroDigito = substracaoPor11SeMaiorQue2CasoContrario0(mod(base,undefined,undefined));
        var segundoDigito = substracaoPor11SeMaiorQue2CasoContrario0(mod(base + primeiroDigito,undefined,undefined));
    ...
    mt: function(valor){
        if(tamanhoNaoE(valor, 11) && tamanhoNaoE(valor,undefined)) {
            return false;
        }

        var base = tamanhoE(valor, 11) ? valor.substring(0, 10) : primeiros(valor,undefined);
        return calculoTrivial(valor, base,undefined);
    },
    ...
    sp: function(valor){
        ...
        if(valor.substr(0, 1) === 'P') {
            ...
            var resto = mod(base, [10, 8, 7, 6, 5, 4, 3, 1],undefined).toString();
            ...
            var primeiraBase = primeiros(valor,undefined);
            segundaBase = valor.substring(9, 11);

            var primeiroResto = mod(primeiraBase, [10, 8, 7, 6, 5, 4, 3, 1],undefined).toString();
            var primeiro = primeiroResto.length > 1 ? primeiroResto[1] : primeiroResto[0];

            var segundoResto = mod(primeiraBase + primeiro + segundaBase, serie(2, 10),undefined).toString();
    ...
    mg: function(valor){
        ...
        var divProdutoLiteral = produtorioLiteral / 10;
        var divProdutoLiteralChar = divProdutoLiteral.toString();
        var primeiro = ((parseInt(divProdutoLiteralChar) + 1) * 10) - produtorioLiteral;
        if(primeiro === 10) {
            primeiro = 0;
        }

        var segundo = substracaoPor11SeMaiorQue2CasoContrario0(mod(base + primeiro, serie(2, 11),undefined));

        return valor === base + primeiro + segundo;
    },

    to: function(valor){
        if(tamanhoNaoE(valor,undefined) && tamanhoNaoE(valor, 11)) {
            return false;
        }
    ...
    go: function(valor){
        ...
        var resto = mod(base,undefined,undefined);
        var digito;
    ...
    df: function(valor){
        ...
        var primeiro = substracaoPor11SeMaiorQue2CasoContrario0(mod(base,undefined,undefined));
        var segundo = substracaoPor11SeMaiorQue2CasoContrario0(mod(base + primeiro,undefined,undefined));
...
export function IEValidator (control: AbstractControl) {

    const uf = control.get('SGL_UF').value;
    const ie = control.get('COD_INSCRIC_ESTADU').value;
    if(ie !== 'X') {
        if(!validar(ie, uf)){
